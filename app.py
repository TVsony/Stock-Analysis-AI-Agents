...
COMMON_STOCKS = {
    ...
    'ICICIBANK': 'ICICIBANK.NS', 'SBIN': 'SBIN.NS', 'ADANI ENTERPRISES': 'ADANIENT.NS',
    'HINDUSTAN UNILEVER': 'HINDUNILVR.NS', 'BHARTI AIRTEL': 'BHARTIARTL.NS',
    'L&T': 'LT.NS', 'MARUTI SUZUKI': 'MARUTI.NS', 'ASIAN PAINTS': 'ASIANPAINT.NS',
    'ITC': 'ITC.NS', 'BAJAJ FINANCE': 'BAJFINANCE.NS', 'KOTAK MAHINDRA BANK': 'KOTAKBANK.NS',
    'POWER GRID': 'POWERGRID.NS', 'HERO MOTOCORP': 'HEROMOTOCO.NS', 'COAL INDIA': 'COALINDIA.NS',
    'ONGC': 'ONGC.NS', 'TATA STEEL': 'TATASTEEL.NS', 'SUN PHARMA': 'SUNPHARMA.NS',
    'ULTRATECH CEMENT': 'ULTRACEMCO.NS', 'HCL TECH': 'HCLTECH.NS', 'BAJAJ AUTO': 'BAJAJ-AUTO.NS',
    'VEDANTA': 'VEDL.NS', 'ADANI PORTS': 'ADANIPORTS.NS', 'INDUSIND BANK': 'INDUSINDBK.NS',
    'TECH MAHINDRA': 'TECHM.NS', 'GRASIM': 'GRASIM.NS', 'BRITANNIA': 'BRITANNIA.NS',
    'AXIS BANK': 'AXISBANK.NS', 'DR REDDY': 'DRREDDY.NS', 'CIPLA': 'CIPLA.NS',
    'ZEE ENTERTAINMENT': 'ZEEL.NS', 'JSW STEEL': 'JSWSTEEL.NS', 'BPCL': 'BPCL.NS'
}
